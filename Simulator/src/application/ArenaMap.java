...
public class ArenaMap {
	...
	public class ArenaMapException extends Exception{
		...
		public  ArenaMapException(int ID,String msg){
			this.ID = ID;
			this.msg = msg;
		}
	}
	...
	public void setArenaMapFromDescriptor(String descriptor) throws ArenaMapException{
		
		//TODO TESTING
		String lines[] = descriptor.split("\\r?\\n");
		if(lines.length != 2){
			throw new ArenaMapException(1,"The descriptor does not contain two line...");
		}
...
//		System.out.println("No header & trailer: " + binStr);
	...
	private void markObstacleCell(String descriptor) throws ArenaMapException {
		String binStr = null;
		try{
			 binStr = hexToBinaryStr(descriptor);			
		}catch(NumberFormatException e){
